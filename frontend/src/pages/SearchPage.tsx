...
// Create a component that uses the filters context and performs the search
const SearchContent: React.FC = () => {
  ...
  }, [selectedDifficulty, selectedLanguage, selectedTimeframe, searchParams]);
  
  // Reset repositories when all filters are cleared and no search term
  useEffect(() => {
    if (!selectedDifficulty && !selectedLanguage && !selectedTimeframe && (!searchParams || !searchParams.searchTerm.trim())) {
      setRepositories([]);
    }
  }, [selectedDifficulty, selectedLanguage, selectedTimeframe, searchParams]);
  ...
  const handleSearch = async (searchData: {
    ...
    // Store search params and let the effect trigger the actual search
...
// Main SearchPage component that provides the filters context
